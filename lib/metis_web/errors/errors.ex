defmodule MetisWeb.Errors do
  alias Ecto.Changeset
  alias MetisWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(Metis.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(Metis.Gettext, "errors", message, options)
    end
  end
